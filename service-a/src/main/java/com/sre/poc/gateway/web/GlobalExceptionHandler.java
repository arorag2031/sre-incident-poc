...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> downstream(WebClientResponseException ex) {
        log.error("Downstream processor returned status={} body={}", ex.getStatusCode(), ex.getResponseBodyAsString());
    ...
    public ResponseEntity<Map<String, Object>> handle(Throwable ex) {
        ...
        log.error("Gateway failure type={} msg={}", errorType, message, ex);
